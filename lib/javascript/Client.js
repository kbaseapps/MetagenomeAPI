...
function MetagenomeAPI(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.search_binned_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "MetagenomeAPI.search_binned_contigs",
            [params], 1, _callback, _errorCallback);
    };
 
     this.search_contigs_in_bin = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "MetagenomeAPI.search_contigs_in_bin",
            [params], 1, _callback, _errorCallback);
    };
 
     this.get_annotated_metagenome_assembly = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "MetagenomeAPI.get_annotated_metagenome_assembly",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "MetagenomeAPI.status",
