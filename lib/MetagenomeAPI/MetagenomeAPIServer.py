...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MetagenomeAPI'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MetagenomeAPI.MetagenomeAPIImpl import MetagenomeAPI  # noqa @IgnorePep8
impl_MetagenomeAPI = MetagenomeAPI(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MetagenomeAPI'
        ...
        self.rpc_service.add(impl_MetagenomeAPI.search_binned_contigs,
                             name='MetagenomeAPI.search_binned_contigs',
                             types=[dict])
        self.method_authentication['MetagenomeAPI.search_binned_contigs'] = 'optional'  # noqa
        self.rpc_service.add(impl_MetagenomeAPI.search_contigs_in_bin,
                             name='MetagenomeAPI.search_contigs_in_bin',
                             types=[dict])
        self.method_authentication['MetagenomeAPI.search_contigs_in_bin'] = 'optional'  # noqa
