...
SERVICE_CAPS = MetagenomeAPI
SPEC_FILE = MetagenomeAPI.spec
URL = https://kbase.us/services/metagenomeapi
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-startup-script:
	...
	echo 'uwsgi -T --lazy --master --processes 5 --threads 5 --http :5000 --wsgi-file $$script_dir/../$(LIB_DIR)/$(SERVICE_CAPS)/$(SERVICE_CAPS)Server.py' >> $(SCRIPTS_DIR)/$(STARTUP_SCRIPT_NAME)
